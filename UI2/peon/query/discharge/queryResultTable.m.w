...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <column name="xcfs" type="String" xid="xid3"></column>
  <column name="xll" type="Decimal" xid="xid4"></column>
  ...
  <div component="$UI/system/components/justep/panel/panel" 
    class="x-panel x-full" xid="panel1"> 
      <div class="x-panel-top" xid="top1"> 
        <div component="$UI/system/components/justep/titleBar/titleBar" title="卸料量查询"
          class="x-titlebar">
          ...
          <div class="x-titlebar-title">卸料量查询</div>  
    ...
    <table class="table table-bordered table-hover table-striped" component="$UI/system/components/bootstrap/table/table" xid="table1" style="width:800px;">
     <thead xid="thead1">
      <tr class="danger" xid="tr1">
       <th xid="col1" style="width:100px;"><![CDATA[卸料类型]]></th> 
       <th xid="col2" style="width:50px;"><![CDATA[卸料量]]></th> 
  ...
  <th xid="col7"><![CDATA[时间]]></th>
     ...
     <tbody class="x-list-template" xid="listTemplate1">
      <tr class="info" xid="tr2">
       <td xid="td1">
        <div component="$UI/system/components/justep/output/output" class="x-output" xid="output1" bind-ref='ref("xcfs")'></div></td> 
       <td xid="td2">
        <div component="$UI/system/components/justep/output/output" class="x-output" xid="output2" bind-ref='ref("xll")'></div></td> 
  ...
  <td xid="td7"><div component="$UI/system/components/justep/output/output" class="x-output" xid="output7" bind-ref='ref("gbsj")'></div></td>
   ...
   <div class="x-content-center x-pull-up" xid="div3">
    ...
    xid="popOver2" opacity="0.9" dismissible="fasle"> 
