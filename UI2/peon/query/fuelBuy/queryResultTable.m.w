  ...
  <div component="$UI/system/components/justep/panel/panel" 
    class="x-panel x-full" xid="panel1"> 
      <div class="x-panel-top" xid="top1"> 
        <div component="$UI/system/components/justep/titleBar/titleBar" title="燃料收购台账查询"
          class="x-titlebar">
          ...
          <div class="x-titlebar-title">燃料收购台账查询</div>  
   ...
   <div component="$UI/system/components/justep/list/list" class="x-list" xid="list1" data="rsData" limit="20">
    <table class="table table-bordered table-hover table-striped" component="$UI/system/components/bootstrap/table/table" xid="table1" style="width:1200px;">
     <thead xid="thead1">
      <tr class="danger" xid="tr1">
       <th xid="col1"><![CDATA[过磅时间]]></th> 
       <th xid="col2"><![CDATA[客户名称]]></th> 
  <th xid="col3"><![CDATA[客户类型]]></th>
  <th xid="col4"><![CDATA[货源地]]></th>
