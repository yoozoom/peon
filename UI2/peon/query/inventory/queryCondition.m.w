...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;top:18px;left:406px;" onLoad="modelLoad"> 
  ...
  <data xid="default2">[{&quot;name&quot;:&quot;直接销售&quot;,&quot;value&quot;:2},{&quot;name&quot;:&quot;破碎料交接&quot;,&quot;value&quot;:3},{&quot;name&quot;:&quot;库存料交接&quot;,&quot;value&quot;:4}]</data></div>
  ...
  <div class="list-group" xid="listGroup2">
   ...
   <input component="$UI/system/components/justep/input/input" class="form-control x-edit" xid="input6"></input></div><div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit5">
   ...
   <select component="$UI/system/components/justep/select/select" class="form-control x-edit" xid="select4" bind-options="rlTypeData" bind-optionsValue="value" bind-optionsLabel="name" bind-optionsCaption="燃料类别"></select></div><div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelInput1">
   <label class="x-label" xid="label1"><![CDATA[盘存月份]]></label>
   <input component="$UI/system/components/justep/input/input" class="form-control x-edit" xid="input1" bind-ref='$model.paramData.ref("startDate")' format="yyyy-MM"></input></div><div xid="div5">
