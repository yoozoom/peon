...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;top:112px;left:196px;"
    onLoad="modelLoad"> 
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-top" xid="top1"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" title="破碎图表"
        class="x-titlebar"> 
        ...
        <div class="x-titlebar-title">破碎图表</div>  
      ...
      <div component="$UI/system/components/bootstrap/accordion/accordion"
        ...
        <div class="panel panel-default" component="$UI/system/components/bootstrap/panel/panel"
          ...
          <div class="panel-heading" xid="heading1"> 
            <h4 class="panel-title" xid="h41"><![CDATA[各项目破碎量]]></h4> 
          </div>  
